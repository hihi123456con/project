            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">Cell Phone Details</h2>
                        <a href="create.php"
                         class="btn btn-success pull-right">Add New Cell Phone</a>
                    </div>
                    <?php
                    // Include config file
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = $result->fetch()){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo "<a href='detail.php?id=". $row['id'] ."' title='View Detail' data-toggle='tooltip'><span class='glyphicon glyphicon-eye-open'></span></a>";
